    ...
    <div class="app-content content">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-body">
                ...
                <form class="form form-horizontal" action="{{ route('admin.announcements.update', $announcement->id) }}"
                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <select name="type" id="type" class="form-control" required>
                                                                <option value="1" {{ old('type', $announcement->type) == '1' ? 'selected' : '' }}>Text Only</option>
                                                                <option value="2" {{ old('type', $announcement->type) == '2' ? 'selected' : '' }}>Media Only</option>
                                                                <option value="3" {{ old('type', $announcement->type) == '3' ? 'selected' : '' }}>Text & Media</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12" id="content-group">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <textarea id="content" class="form-control" name="content" rows="6" placeholder="Announcement Content">{{ old('content', $announcement->content) }}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9">
                                                            ...
                                                            @if ($announcement->media)
                                                                <div class="mt-1">
                                                                    <a href="{{ asset('storage/' . $announcement->media) }}"
                                                                        target="_blank" id="current-media-link" data-filename="{{ basename($announcement->media) }}">View Current Media ({{ basename($announcement->media) }})</a>
                                                                </div>
                                                            @endif
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <textarea id="description" class="form-control" name="description" rows="3"
                                                                placeholder="Small description here...">{{ old('description', $announcement->description) }}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="col-md-9">
                                                            <select name="academic_year_id" id="academic_year_id" class="form-control" required>
                                                                ...
                                                                @foreach($academicYears as $year)
                                                                    <option value="{{ $year->id }}" {{ old('academic_year_id', $announcement->academic_year_id) == $year->id ? 'selected' : '' }}>{{ $year->name }}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <select name="priority" id="priority" class="form-control" required>
                                                                <option value="low" {{ old('priority', $announcement->priority) === 'low' ? 'selected' : '' }}>Low (Standard Ordering)</option>
                                                                <option value="medium" {{ old('priority', $announcement->priority) === 'medium' ? 'selected' : '' }}>Medium (Featured Ordering)</option>
                                                                <option value="high" {{ old('priority', $announcement->priority) === 'high' ? 'selected' : '' }}>High (Prominent Display & Alerts)</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input type="datetime-local" name="show_from" id="show_from" 
                                                                   value="{{ old('show_from', $announcement->show_from ? $announcement->show_from->format('Y-m-d\TH:i') : '') }}" class="form-control">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input type="datetime-local" name="expires_at" id="expires_at" 
                                                                   value="{{ old('expires_at', $announcement->expires_at ? $announcement->expires_at->format('Y-m-d\TH:i') : '') }}" class="form-control">
                                                        ...
                                                        <div class="col-md-9">
                                                            <div class="custom-control custom-switch custom-control-inline">
                                                                <input type="checkbox" class="custom-control-input"
                                                                    id="is_draft" name="is_draft" {{ old('is_draft', $announcement->is_draft ? '1' : '0') == '1' ? 'checked' : '' }}>
                                        ...
                                        <div class="recipient-group-card">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="target_all_active_students" name="target_all_active_students" value="1"
                                                    {{ old('target_all_active_students', in_array('all_active_students', $currentTargetTypes)) ? 'checked' : '' }}>
                                        ...
                                        <div class="recipient-group-card">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="target_all_tutors" name="target_all_tutors" value="1"
                                                    {{ old('target_all_tutors', in_array('all_tutors', $currentTargetTypes)) ? 'checked' : '' }}>
                                        ...
                                        <div class="recipient-group-card">
                                            ...
                                            <select class="form-control select2" name="target_classes[]" multiple id="target_classes">
                                                @foreach($classes as $class)
                                                    <option value="{{ $class->id }}" {{ is_array(old('target_classes', $currentClasses)) && in_array($class->id, old('target_classes', $currentClasses)) ? 'selected' : '' }}>
                                        ...
                                        <div class="recipient-group-card">
                                            ...
                                            <select class="form-control select2" name="target_year_groups[]" multiple id="target_year_groups">
                                                @foreach($yearGroups as $group)
                                                    <option value="{{ $group->id }}" {{ is_array(old('target_year_groups', $currentYearGroups)) && in_array($group->id, old('target_year_groups', $currentYearGroups)) ? 'selected' : '' }}>
                                                        {{ $group->title }}
                                                    </option>
                                                @endforeach
                                            </select>
                                            ...
                                            <select class="form-control select2" name="target_users[]" multiple id="target_users">
                                                <optgroup label="Students">
                                                    @foreach($users->where('role', 'student') as $user)
                                                        <option value="{{ $user->id }}" {{ is_array(old('target_users', $currentUsers)) && in_array($user->id, old('target_users', $currentUsers)) ? 'selected' : '' }}>
                                ...
                                <div class="card-body d-flex justify-content-between align-items-center">
                                    <div>
                                        <button type="submit" class="btn btn-primary mr-1">
                                            <i class="feather icon-save"></i> Update Announcement
                                        </button>
            ...
            document.getElementById('preview-btn').addEventListener('click', function() {
                ...
                if ((type == 2 || type == 3)) {
                    if (mediaInput.files && mediaInput.files[0]) {
                        ...
                        // Check if current media exists
                        const curMedia = document.getElementById('current-media-link');
                        if (curMedia) {
                            mediaContainer.style.display = 'block';
                            mMediaContainer.style.display = 'block';
                            const url = curMedia.href;
                            const filename = curMedia.dataset.filename;
                            if (url.match(/\.(jpeg|jpg|gif|png)/i)) {
                                document.getElementById('preview-img').src = url;
                                document.getElementById('m-preview-img').src = url;
                                imgBox.style.display = 'block';
                                mImgBox.style.display = 'block';
                            } else {
                                document.getElementById('preview-pdf-name').textContent = filename;
                                document.getElementById('m-preview-pdf-name').textContent = filename;
                                pdfBox.style.display = 'block';
                                mPdfBox.style.display = 'block';
                            }
                        }
