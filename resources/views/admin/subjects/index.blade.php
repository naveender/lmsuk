            ...
            <div class="content-body">
                ...
                <div class="card">
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            <form method="GET" action="{{ route('admin.subjects.index') }}" class="row mb-4 g-2 align-items-end">
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4 d-flex justify-content-between">
                                    ...
                                    <a href="{{ route('admin.subjects.index') }}" class="btn btn-secondary flex-fill text-center">Reset</a>
                                </div>
                            </form>
                        </div>
                    </div>
                                        ...
                                        <tbody>
                                            @forelse($subjects as $index => $subject)
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if($subject->image)
                                                            <img src="{{ asset('storage/' . $subject->image) }}" alt="Image" style="width: 50px; height: 50px; object-fit: cover; border-radius: 4px;">
                                                        @else
                                                    ...
                                                    <td>
                                                        <a href="{{ route('admin.subjects.edit', $subject->id) }}" class="btn btn-sm btn-primary mb-1">
