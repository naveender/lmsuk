                         ...
                         <div class="col-lg-3 col-sm-6 col-12">
                             <div class="card">
                                 <div class="card-header d-flex flex-column align-items-start pb-0">
                                     ...
                                     <p class="mb-0 mt-2">Total Users</p>
                                     <h2 class="text-bold-700 mt-1">{{ $stats['total_users'] ?? 0 }}</h2>
                         ...
                         <div class="col-lg-3 col-sm-6 col-12">
                             <div class="card">
                                 <div class="card-header d-flex flex-column align-items-start pb-0">
                                     ...
                                     <p class="mb-0 mt-2">Total Categories</p>
                         ...
                         <div class="col-lg-3 col-sm-6 col-12">
                             <div class="card">
                                 <div class="card-header d-flex flex-column align-items-start pb-0">
                                     ...
                                     <p class="mb-0 mt-2">Total Topics</p>
                                     <h2 class="text-bold-700 mt-1">{{ $stats['total_topics'] ?? 0 }}</h2>
                         ...
                         <div class="col-lg-3 col-sm-6 col-12">
                             <div class="card">
                                 <div class="card-header d-flex flex-column align-items-start pb-0">
                                     ...
                                     <p class="mb-0 mt-2">Total Tests</p>
