    ...
    <div class="app-content content">
        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0 font-weight-bold">Students Management</h2>
            ...
            <div class="content-body">
                <div class="row mb-2">
                    <div class="col-9"><p>Manage All Students</p></div>
                    <div class="col-3">
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            <div class="users-list-filter">
                                <form method="GET" action="{{ route('admin.students.index') }}" class="row mb-4 g-2 align-items-end">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-4 d-flex justify-content-between">
                                        ...
                                        <a href="{{ route('admin.students.index') }}" class="btn btn-secondary flex-fill text-center">Reset</a>
                                    </div>
                                </form>
                            </div>
                        </div>
