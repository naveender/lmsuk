                                                    ...
                                                    <div class="col-12 col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" name="group_year" required>
                                                                ...
                                                                <option value="1" {{ old('group_year') == '1' ? 'selected' : '' }}>1st year</option>
                                                                <option value="2" {{ old('group_year') == '2' ? 'selected' : '' }}>2nd year</option>
                                                                <option value="3" {{ old('group_year') == '3' ? 'selected' : '' }}>3rd year</option>
                                                                <option value="4" {{ old('group_year') == '4' ? 'selected' : '' }}>4th year</option>
                                                                <option value="5" {{ old('group_year') == '5' ? 'selected' : '' }}>5th year</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="col-12 col-sm-6">
                                                                ...
                                                                <li class="d-inline-block mr-2">
                                                                    <fieldset>
                                                                        <div class="vs-radio-con">
                                                                            <input type="radio" name="gender" {{ old('gender', 'male') == 'male' ? 'checked' : '' }}
                                                                                value="male">
                                                                            <span class="vs-radio">
